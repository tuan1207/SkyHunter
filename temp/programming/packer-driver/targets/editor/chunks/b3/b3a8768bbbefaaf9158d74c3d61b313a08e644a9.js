      ...
      _export("BulletE", BulletE = (_dec = ccclass('BulletE'), _dec(_class = class BulletE extends Component {
        ...
        bulletMove() {
          if (this.node.name == 'enemyb0') {
            ...
            let posEnd = new Vec3(posXEnd, posYEnd);
            const distance = Vec3.distance(this.node.position, posEnd);
...
//# sourceMappingURL=b3a8768bbbefaaf9158d74c3d61b313a08e644a9.js.map