          ...
          if (otherCollider.node.name.startsWith('bullet') || otherCollider.node.name.startsWith('rocket')) {
            if (this.node.name === 'boss001') {
              ...
              if (this.bulletCont1.length >= 150) {
                ...
                (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
                  error: Error()
                }), GameCtrl) : GameCtrl).instance.checkTurn2 = true; // this.scheduleOnce(() => {GameCtrl.instance.spawnTurn2(0)});
            ...
            if (this.node.name === 'boss002') {
              ...
              if (this.bulletCont2.length >= 150) {
                ...
                (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
                  error: Error()
                }), GameCtrl) : GameCtrl).instance.checkTurn2 = true; // this.scheduleOnce(() => {GameCtrl.instance.spawnTurn3(0)});
            ...
            if (this.node.name === 'boss003') {
              ...
              if (this.bulletCont3.length >= 150) {
                ...
                (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
                  error: Error()
                }), GameCtrl) : GameCtrl).instance.checkTurn3 = true; // this.scheduleOnce(() => {GameCtrl.instance.spawnTurn1(0)});
...
//# sourceMappingURL=9b0a4db737aafec78548dd6dc0123467905687df.js.map