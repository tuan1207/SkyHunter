    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          let angle = math.Vec3.angle(this.Pos, new Vec3(0, 1, 0)); // Góc quay của joystick

          let distance = math.Vec3.distance(this.VecY, this.Pos); // Khoảng cách từ tâm của joystick đến điểm đang chạm
...
//# sourceMappingURL=62f9b100bf8df8e4284032f666315251eb2e850b.js.map