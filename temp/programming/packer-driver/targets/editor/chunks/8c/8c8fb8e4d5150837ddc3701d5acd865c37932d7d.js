      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          for (let i = 0; i < this.listBullet.length; i++) {
            ...
            let posXPlane = Plane.instance.Plane.position.x;
            let posYPlane = Plane.instance.Plane.position.y;
            let posBullet = new Vec3(posXPlane, posYPlane + 60);
...
//# sourceMappingURL=8c8fb8e4d5150837ddc3701d5acd865c37932d7d.js.map