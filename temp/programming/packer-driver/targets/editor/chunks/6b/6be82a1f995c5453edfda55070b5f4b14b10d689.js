    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        countAngleStick(event, dt) {
          let angle = event.Stick.angle; // Góc quay của joystick

          let distance = event.Stick.distance; // Khoảng cách từ tâm của joystick đến điểm đang chạm
...
//# sourceMappingURL=6be82a1f995c5453edfda55070b5f4b14b10d689.js.map