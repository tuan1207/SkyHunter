      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 1) {
            let bulletPositions = [new Vec2(-2, 19), // Vị trí cho node đạn thứ nhất
            ...
            for (let i = 0; i < 3; i++) {
              let prefabInstance = instantiate(bulletPrefab0);
              let veloPre = prefabInstance.getComponent(RigidBody2D);
...
//# sourceMappingURL=84d5d1639165c3e3b12c38bd2ecfd4dfbbc81532.js.map