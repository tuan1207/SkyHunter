          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x - 56 - 12 * (j + 2), this.node.worldPosition.y + 1000, this.node.worldPosition.z);
              }
...
//# sourceMappingURL=c765d451c93143d59d34b8192926ae32c321a429.js.map