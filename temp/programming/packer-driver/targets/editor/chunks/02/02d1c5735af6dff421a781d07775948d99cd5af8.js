    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          let distance = math.Vec3.distance(this.VecY, this.Pos); // let distance = math.Vec3.distance(this.VecY, this.Pos);

          if (this.plane.position.x < 600 || this.plane.position.x > -600 || this.plane.position.y < 300 || this.plane.position.y > -300) {
...
//# sourceMappingURL=02d1c5735af6dff421a781d07775948d99cd5af8.js.map