System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, Prefab, instantiate, Collider2D, Contact2DType, GameCtrl, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Enemy;
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Enemy extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (selfCollider.node.name.startsWith('enemy2')) {
            this.scheduleOnce(() => {
              this.contE2.push(otherCollider);
            });
          ...
          if (selfCollider.node.name.startsWith('enemy3')) {
            this.scheduleOnce(() => {
              this.contE3.push(otherCollider);
            });
...
//# sourceMappingURL=601e8f675fe71732ae67a77dcbd37510c7f9c873.js.map