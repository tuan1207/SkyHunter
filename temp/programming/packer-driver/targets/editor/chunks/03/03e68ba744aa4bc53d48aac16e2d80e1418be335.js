          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 1; j++) {
              ...
              if (enemyPre.name.endsWith('_0')) {
                prefabInstance.setWorldPosition(this.node.position.x + 360, this.node.position.y, this.node.position.z); // prefabInstance.setWorldPosition(this.listPos[0].x + (120 * (j - 2)), this.listPos[0].y, this.listPos[0].z);
              }
...
//# sourceMappingURL=03e68ba744aa4bc53d48aac16e2d80e1418be335.js.map