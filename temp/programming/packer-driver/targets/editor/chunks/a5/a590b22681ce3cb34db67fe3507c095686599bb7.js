System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Node, input, Input, KeyCode, Vec3, Collider2D, Contact2DType, Animation, Prefab, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, Plane;
    ...
    execute: function () {
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        update(dt) {
          ...
          this.planeMove(dt); // this.schedule(this.spawnBullet, 0.4, macro.REPEAT_FOREVER, 0);
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 1) {
            let bulletPrefab1 = this.listBullet[1];
            let prefabInstance1 = instantiate(bulletPrefab1);
            ...
            let bulletPrefab2 = this.listBullet[2];
            let prefabInstance2 = instantiate(bulletPrefab2);
          ...
          if (this.listItemB.length === 2) {
            let bulletPrefab3 = this.listBullet[3];
            let prefabInstance3 = instantiate(bulletPrefab3);
            ...
            let bulletPrefab4 = this.listBullet[4];
            let prefabInstance4 = instantiate(bulletPrefab4);
...
//# sourceMappingURL=a590b22681ce3cb34db67fe3507c095686599bb7.js.map