System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, ButtonMenuScene;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ButtonMenuScene", ButtonMenuScene = (_dec = ccclass('ButtonMenuScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec(_class = (_class2 = class ButtonMenuScene extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "playScene", _descriptor5, this);
        }
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "playScene", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=db10a47e49b9b67df6bb8c52bd3d3d88f4ae89b2.js.map