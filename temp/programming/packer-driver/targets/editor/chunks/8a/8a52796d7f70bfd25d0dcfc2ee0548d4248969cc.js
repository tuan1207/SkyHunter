    ...
    execute: function () {
      ...
      _export("Item", Item = (_dec = ccclass('Item'), _dec(_class = class Item extends Component {
        ...
        start() {
          ...
          this.selfCollider.group = 6;
        }

        onBeginContact(contact) {
          console.log(this.selfCollider.group, this.otherCollider.group);
        }
...
//# sourceMappingURL=8a52796d7f70bfd25d0dcfc2ee0548d4248969cc.js.map