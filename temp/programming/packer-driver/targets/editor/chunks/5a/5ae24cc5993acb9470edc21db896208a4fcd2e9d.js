      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(dt) {
          ...
          if (distance > 1) {
            ...
            let posX = this.node.position.x + direction.x * distance;
            let posY = this.node.position.y + direction.y * distance;
...
//# sourceMappingURL=5ae24cc5993acb9470edc21db896208a4fcd2e9d.js.map