    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Enemy extends Component {
        ...
        destroyB() {
          ...
          prefabInstance.parent = (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
          }), GameCtrl) : GameCtrl).instance.node;
          prefabInstance.setWorldPosition((_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
...
//# sourceMappingURL=cad86680e46a001ac2539e21862cb21cea3a920d.js.map