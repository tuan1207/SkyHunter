System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, Vec3, instantiate, macro, Label, ProgressBar, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _class3, _crd, ccclass, property, GameCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        ...
        start() {
          let spawnFunc = [{
            func: this.spawnTurn1,
            delay: 6
          }, {
            func: this.spawnBoss1,
            delay: 72
          }, {
            func: this.spawnTurn2,
            delay: 122
          }, {
            func: this.spawnBoss2,
            delay: 188
          }, {
            func: this.spawnTurn3,
            delay: 238
          }, {
            func: this.spawnBoss3,
            delay: 304
          }];
        ...
        countPoint() {
          ...
          this.highPointLb.string = `${this.destroyCount}`;
        }
        ...
        savePoint() {
          ...
          if (this.highPoint < this.destroyCount) {
            ...
            localStorage.setItem('highPoint', this.highPoint.toString());
          }
        }

        saveHighPoint() {
          const storedHighPoint = parseInt(localStorage.getItem('highPoint'));
...
//# sourceMappingURL=ca376e812278090a7db3374e79e7e14ed4d337c2.js.map