      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 0) {
            ...
            let prefabInstance1 = instantiate(bulletPrefab0);
            prefabInstance0.getComponent(RigidBody2D).linearVelocity = new Vec2(0, 20);
            prefabInstance1.getComponent(RigidBody2D).linearVelocity = new Vec2(2, 19.5);
            ...
            prefabInstance1.setWorldPosition(this.node.worldPosition.x + 10, this.node.worldPosition.y + 60, this.node.worldPosition.z);
          }
...
//# sourceMappingURL=7a2af69ad6cb2523e4bda4b8bc07792fe8b3df60.js.map