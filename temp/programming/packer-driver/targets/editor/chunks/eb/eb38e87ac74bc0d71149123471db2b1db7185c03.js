            ...
            for (let i = 0; i < this.listBulletB3.length; i++) {
              ...
              for (let j = 0; j < 5; j++) {
                ...
                if (enemyPre.name.endsWith('_0') || enemyPre.name.endsWith('_1') || enemyPre.name.endsWith('_2') || enemyPre.name.endsWith('_3') || enemyPre.name.endsWith('_4')) {
                  prefabInstance.setWorldPosition(this.node.worldPosition.x - 210, this.node.worldPosition.y, this.node.worldPosition.z);
                }
...
//# sourceMappingURL=eb38e87ac74bc0d71149123471db2b1db7185c03.js.map