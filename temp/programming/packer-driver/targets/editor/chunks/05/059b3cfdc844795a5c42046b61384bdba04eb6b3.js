          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x - 280 - 60 * (j + 2), this.node.worldPosition.y + 1000, this.node.worldPosition.z);
              }
...
//# sourceMappingURL=059b3cfdc844795a5c42046b61384bdba04eb6b3.js.map