    ...
    execute: function () {
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        update(dt) {
          ...
          this.planeMove(dt);
          this.schedule(this.spawnBullet, 4, macro.REPEAT_FOREVER, 0); // this.schedule(this.spawnRocket, 0.7, macro.REPEAT_FOREVER, 0);
        }
...
//# sourceMappingURL=ea99c6b490f3fdd53a5e537c54892a21146cad2a.js.map