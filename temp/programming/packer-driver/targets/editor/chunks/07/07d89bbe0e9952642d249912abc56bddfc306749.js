      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(dt) {
          ...
          if (distance > 1) {
            ...
            let posX = this.node.position.x + direction.x * distance * 0.005;
            let posY = this.node.position.y + direction.y * distance * 0.005;
...
//# sourceMappingURL=07d89bbe0e9952642d249912abc56bddfc306749.js.map