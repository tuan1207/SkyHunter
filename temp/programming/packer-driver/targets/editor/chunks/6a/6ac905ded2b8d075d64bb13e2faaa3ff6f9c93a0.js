    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec(_class = (_class2 = class GameCtrl extends Component {
        constructor(...args) {
          ...
          this.listPos = [new Vec3(640, 760), new Vec3(-50, 760), new Vec3(640, 760), new Vec3(-50, 560), new Vec3(640, 760), new Vec3(-50, 270), new Vec3(640, 760), new Vec3(1330, 560), new Vec3(1330, 270), new Vec3(1330, 760)];
        }
          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 1; j++) {
              ...
              if (enemyPre.name.endsWith('_0')) {
                prefabInstance.setWorldPosition(this.listPos[0].x, this.listPos[0].y, 0);
              } else {
                prefabInstance.setWorldPosition(100, 100, 0);
              }
            }
          } else {
            return;
...
//# sourceMappingURL=6ac905ded2b8d075d64bb13e2faaa3ff6f9c93a0.js.map