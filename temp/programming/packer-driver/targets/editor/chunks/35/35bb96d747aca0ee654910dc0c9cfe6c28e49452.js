System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Node, input, Input, KeyCode, Vec3, Collider2D, Contact2DType, Animation, Prefab, macro, UITransform, GameCtrl, Audio, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _class3, _crd, ccclass, property, Plane;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'instantiate', 'Node', 'input', 'Input', 'EventKeyboard', 'KeyCode', 'Vec3', 'Collider2D', 'Contact2DType', 'IPhysics2DContact', 'EPhysics2DDrawFlags', 'PhysicsSystem2D', 'Animation', 'Prefab', 'macro', 'Canvas', 'EventTouch', 'UITransform']);
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "Stick", _descriptor6, this);
        ...
        onTouchMove(event) {
          if (!this.touchEnabled) return;
          let wp = event.touch.getUILocation();
          let posMouse = this.node.parent.getComponent(UITransform).convertToWorldSpaceAR(new Vec3(wp.x, wp.y));
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "Stick", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=35bb96d747aca0ee654910dc0c9cfe6c28e49452.js.map