          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x - 280 - 60 * (j + 2), this.node.worldPosition.y, this.node.worldPosition.z);
              }
...
//# sourceMappingURL=35d06ef017003e21366c3e4acd17c1aecb9d07cd.js.map