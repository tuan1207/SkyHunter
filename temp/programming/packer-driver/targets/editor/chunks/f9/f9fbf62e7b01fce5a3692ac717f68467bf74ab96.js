          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x, this.node.worldPosition.y + 20, this.node.worldPosition.z);
              }
...
//# sourceMappingURL=f9fbf62e7b01fce5a3692ac717f68467bf74ab96.js.map