System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Canvas, Component, director, Node, Plane, GameCtrl, AudioToggle, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, ButtonPlayScene;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ButtonPlayScene", ButtonPlayScene = (_dec = ccclass('ButtonPlayScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Node), _dec7 = property(Canvas), _dec(_class = (_class2 = class ButtonPlayScene extends Component {
        ...
        onLoad() {
          this.pauseNode.setParent(this.canvas.node);
        }
...
//# sourceMappingURL=12378eafa63901eac8d9e8039b7adfd7081cf8d3.js.map