System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Vec3', 'Node', 'Prefab', 'instantiate', 'Collider2D', 'Contact2DType', 'IPhysics2DContact']);
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Enemy extends Component {
        ...
        enemyMove() {
          ...
          if (this.node.name.endsWith('_1')) {
            ...
            posX += this.bulletSpeed; // posY -= this.bulletSpeed * 0.5;
...
//# sourceMappingURL=d2bb1356c55706cc387360ff6e9ee868ae7090ef.js.map