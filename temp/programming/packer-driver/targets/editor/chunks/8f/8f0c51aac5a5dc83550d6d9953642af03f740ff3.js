      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(dt) {
          ...
          if (distance > 1) {
            ...
            let posX = this.node.position.x + direction.x * distance * 0.1;
            let posY = this.node.position.y + direction.y * distance * 0.1;
...
//# sourceMappingURL=8f0c51aac5a5dc83550d6d9953642af03f740ff3.js.map