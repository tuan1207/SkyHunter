System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransform, Vec3, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, JoyStick;
    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          if (stickMag > this.preStickMag) {
            this.preStickMag = stickMag;

            if (this.preStickMag === 100) {
              stickMag = this.preStickMag;
            }

            console.log(stickMag);
          }

          this.Stick.setPosition(this.Pos); // let direction = this.Pos.clone().subtract(this.VecY).normalize();
...
//# sourceMappingURL=31615c3a7ac0a10b34946597c1ed1726625238de.js.map