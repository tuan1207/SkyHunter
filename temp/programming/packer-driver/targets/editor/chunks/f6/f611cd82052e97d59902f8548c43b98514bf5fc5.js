    ...
    execute: function () {
      ...
      _export("AudioToggle", AudioToggle = (_dec = ccclass('AudioToggle'), _dec2 = property(AudioClip), _dec3 = property(Toggle), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(AudioSource), _dec7 = property(Toggle), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(AudioSource), _dec(_class = (_class2 = (_class3 = class AudioToggle extends Component {
        ...
        onLoad() {
          ...
          (_sys$localStorage$get = sys.localStorage.getItem('audioStatus')) != null ? _sys$localStorage$get : 'on';
          (_sys$localStorage$get2 = sys.localStorage.getItem('musicStatus')) != null ? _sys$localStorage$get2 : 'on';
          this.scheduleOnce(() => {
            this.updateUI();
          }, 1);
        }
        ...
        updateUI() {
          var _sys$localStorage$get3, _sys$localStorage$get4;

          let savedAStatus = (_sys$localStorage$get3 = sys.localStorage.getItem('audioStatus')) != null ? _sys$localStorage$get3 : 'on';
          ...
          let savedMStatus = (_sys$localStorage$get4 = sys.localStorage.getItem('musicStatus')) != null ? _sys$localStorage$get4 : 'on';
...
//# sourceMappingURL=f611cd82052e97d59902f8548c43b98514bf5fc5.js.map