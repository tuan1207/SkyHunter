    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          if (this.plane.position.x < 500 || this.plane.position.x > -500 || this.plane.position.y < 280 || this.plane.position.y > -280) {
...
//# sourceMappingURL=85b275b7a6d859da7d8bc5b5af5bb0fee073d0f8.js.map