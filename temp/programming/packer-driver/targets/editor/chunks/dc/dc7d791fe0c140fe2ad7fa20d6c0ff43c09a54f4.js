    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        constructor(...args) {
          ...
          this.checkTurn2 = false;
          this.checkTurn3 = false;
          ...
          this.spawnTurnFunctions = [this.spawnTurn1, this.spawnTurn2, this.spawnTurn3];
        }
        ...
        onLoad() {
          ...
          //     {func: this.spawnBoss1, delay: 72},
          //     {func: this.spawnTurn2, delay: 122},
          //     {func: this.spawnBoss2, delay: 188},
          //     {func: this.spawnTurn3, delay: 238},
          //     {func: this.spawnBoss3, delay: 304},
          // ];
        ...
        // Hàm để lặp qua các hàm spawnTurn
        spawnAllTurns() {
          for (let i = 0; i < this.spawnTurnFunctions.length; i++) {
            // Kiểm tra điều kiện trước khi gọi hàm
            if (this.checkTurn(i + 1)) {
              this.spawnTurnFunctions[i].call(this);
            }
          }
        } // Hàm kiểm tra xem có nên gọi hàm spawnTurn hay không


        checkTurn(turnNumber) {
          switch (turnNumber) {
            case 1:
              return this.checkTurn1;

            case 2:
              return this.checkTurn2;

            case 3:
              return this.checkTurn3;
...
//# sourceMappingURL=dc7d791fe0c140fe2ad7fa20d6c0ff43c09a54f4.js.map