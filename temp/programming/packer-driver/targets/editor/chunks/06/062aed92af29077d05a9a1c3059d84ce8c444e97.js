          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.listPos[1].x - 100 * (0 + j), this.listPos[1].y, this.listPos[0].z);
...
//# sourceMappingURL=062aed92af29077d05a9a1c3059d84ce8c444e97.js.map