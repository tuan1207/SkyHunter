System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Vec3, instantiate, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, GameCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        constructor(...args) {
          super(...args);
          ...
          this.listPos = [new Vec3(640, 360), //turn 1, 3, 5, 7
        ...
        spawnTurn1(i) {
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              prefabInstance.parent = this.node.parent; // if(enemyPre.name.endsWith('_0')){
              ...
              //     prefabInstance.setWorldPosition(this.listPos[2].x + (120 * (j - 2)), this.listPos[2].y, this.listPos[2].z);
              // }
              // if(enemyPre.name.endsWith('_4')){
              //     prefabInstance.setWorldPosition(this.listPos[0].x, this.listPos[0].y + (120 * (j - 2)), this.listPos[0].z);
              // }
              // if(enemyPre.name.endsWith('_5')){
              //     prefabInstance.setWorldPosition(this.listPos[3].x + (120 * (j - 2)), this.listPos[3].y, this.listPos[3].z);
              // }
              // if(enemyPre.name.endsWith('_6')){
              //     prefabInstance.setWorldPosition(this.listPos[0].x + (120 * (j - 2)), this.listPos[0].y, this.listPos[0].z);
              // }
              // if(enemyPre.name.endsWith('_7')){
              //     prefabInstance.setWorldPosition(this.listPos[4].x  + (120 * (j - 2)), this.listPos[4].y, this.listPos[4].z);
              // }
              // if(enemyPre.name.endsWith('_8')){
              //     prefabInstance.setWorldPosition(this.listPos[5].x + (120 * (j - 2)), this.listPos[5].y, this.listPos[5].z);
              // }
...
//# sourceMappingURL=8d29dd1cd295bbc27897f29afdb0a300ffaeab3d.js.map