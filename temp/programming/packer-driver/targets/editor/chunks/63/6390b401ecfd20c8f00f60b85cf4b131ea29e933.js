        ...
        spawnTurn1(i) {
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              prefabInstance.parent = this.node.parent; // if(enemyPre.name.endsWith('_0')){ - (100 * (0 + j))
              //     prefabInstance.setWorldPosition(this.listPos[0].x + (120 * (j - 2)), this.listPos[0].y, this.listPos[0].z); + (60 * (j + 1))
              // }

              if (enemyPre.name.endsWith('1_1')) {
                prefabInstance.setWorldPosition(this.listPos[1].x + 120 * (j - 2), this.listPos[1].y, this.listPos[0].z);
...
//# sourceMappingURL=6390b401ecfd20c8f00f60b85cf4b131ea29e933.js.map