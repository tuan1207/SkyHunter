    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec(_class = (_class2 = class GameCtrl extends Component {
        constructor(...args) {
          ...
          this.listPos = [new Vec3(640, 760), new Vec3(-50, 760), new Vec3(640, 760), new Vec3(-50, 560), new Vec3(640, 760), new Vec3(640, 760), new Vec3(640, 760)];
        }
...
//# sourceMappingURL=453d1e411d8b558838ea681450aafa50c119c9d3.js.map