            ...
            for (let i = 0; i < this.listBulletB3.length; i++) {
              ...
              for (let j = 0; j < 5; j++) {
                ...
                if (enemyPre.name.endsWith('_0') || enemyPre.name.endsWith('_1')) {
                  this.schedule(prefabInstance.setWorldPosition(this.node.worldPosition.x - 50, this.node.worldPosition.y, this.node.worldPosition.z), 0.5, j, 0); // prefabInstance.setWorldPosition(this.node.worldPosition.x - 50, this.node.worldPosition.y, this.node.worldPosition.z);
                }
...
//# sourceMappingURL=46b6319074078800757869cae6c20e34c180f1c5.js.map