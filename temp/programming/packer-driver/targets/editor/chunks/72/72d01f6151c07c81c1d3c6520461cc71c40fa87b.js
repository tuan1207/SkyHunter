    ...
    execute: function () {
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        update(dt) {
          ...
          this.planeMove(dt);
          this.schedule(this.spawnBullet, 0.3, macro.REPEAT_FOREVER, 0);
          this.schedule(this.spawnBullet, 0.7, macro.REPEAT_FOREVER, 0);
        }
...
//# sourceMappingURL=72d01f6151c07c81c1d3c6520461cc71c40fa87b.js.map