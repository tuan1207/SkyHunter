      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(dt) {
          ...
          if (distance > 1) {
            ...
            let posX = this.node.position.x + direction.x * distance * 0.05;
            let posY = this.node.position.y + direction.y * distance * 0.05;
...
//# sourceMappingURL=bff1a9f3baebe0678d0b4012f27ab58bb41ba766.js.map