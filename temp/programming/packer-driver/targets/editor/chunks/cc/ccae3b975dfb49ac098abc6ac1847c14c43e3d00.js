  ...
  return {
    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickStart(event) {// let wp = event.getUILocation();
        ...
        onStickMove(event, dt) {
          ...
          let distance = math.Vec3.distance(this.VecY, this.Pos); // Lưu trữ hướng di chuyển của stick trước đó
          ...
          let posY = this.plane.position.y + direction.y * distance * 0.05; // Cập nhật vị trí của mặt phẳng
...
//# sourceMappingURL=ccae3b975dfb49ac098abc6ac1847c14c43e3d00.js.map