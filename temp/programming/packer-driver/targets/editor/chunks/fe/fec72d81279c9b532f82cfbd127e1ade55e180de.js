      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 0) {
            ...
            prefabInstance0.parent = this.node.parent; // prefabInstance0.setWorldPosition(this.node.worldPosition.x, this.node.worldPosition.y+60, this.node.worldPosition.z);

            prefabInstance0.setPosition(this.node.worldPosition);
          }
...
//# sourceMappingURL=fec72d81279c9b532f82cfbd127e1ade55e180de.js.map