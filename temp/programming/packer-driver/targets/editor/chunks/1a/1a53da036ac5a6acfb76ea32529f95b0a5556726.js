    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        moveRandom() {
          ...
          const randomX = Math.random() * (1000 - -1000) - 1000; // Random x position between -1000 and 1000

          const randomY = Math.random() * (600 - 200) + 200; // Random y position between 200 and 600

          const randomPosition = new Vec3(randomX, randomY);
          const distance = Vec3.distance(this.node.position, randomPosition);
          const duration = distance / this.speed; // Move to the random position
...
//# sourceMappingURL=1a53da036ac5a6acfb76ea32529f95b0a5556726.js.map