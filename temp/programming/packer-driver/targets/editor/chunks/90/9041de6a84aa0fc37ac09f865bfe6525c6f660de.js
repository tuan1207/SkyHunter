System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, Vec3, instantiate, macro, Label, ProgressBar, sys, NodePool, ButtonPlayScene, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _class3, _crd, ccclass, property, GameCtrl;
    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        ...
        onLoad() {
          ...
          this.schedule(this.spawnTurn1, 6, 9, 0); // this.spawn();
          // this.schedule(this.spawnObject, 5, macro.REPEAT_FOREVER, 0);

          this.schedule(this.countEle, 6, macro.REPEAT_FOREVER, 0);
        ...
        //             prefabInstance.getComponent(RigidBody2D).linearVelocity = new Vec2 (0, -10);
        ...
        spawnTurn1() {
          ...
          let enemyPre = this.enemyWave1[this.countElement];

          for (let j = 0; j < 5; j++) {
            console.log('da spawn', this.countElement);
...
//# sourceMappingURL=9041de6a84aa0fc37ac09f865bfe6525c6f660de.js.map