          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x - 100 * (j + 2), this.node.worldPosition.y + 100 * (j - 2), this.node.worldPosition.z);
              }
...
//# sourceMappingURL=2e7e1025b7408b5f44da6c3a3b40bb812c237a03.js.map