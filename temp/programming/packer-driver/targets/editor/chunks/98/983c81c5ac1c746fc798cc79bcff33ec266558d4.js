          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 1; j++) {
              ...
              if (enemyPre.name.endsWith('_0')) {
                prefabInstance.setWorldPosition(this.node.position.x, this.node.position.y, this.node.position.z); // prefabInstance.setWorldPosition(this.listPos[0].x + (120 * (j - 2)), this.listPos[0].y, this.listPos[0].z);
              }
...
//# sourceMappingURL=983c81c5ac1c746fc798cc79bcff33ec266558d4.js.map