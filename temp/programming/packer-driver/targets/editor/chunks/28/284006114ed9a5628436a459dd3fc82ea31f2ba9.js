  ...
  return {
    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        movePlane() {
          let posX = this.plane.position.x + this.direction.x * this.distance * 0.05;
          let posY = this.plane.position.y + this.direction.y * this.distance * 0.05;
...
//# sourceMappingURL=284006114ed9a5628436a459dd3fc82ea31f2ba9.js.map