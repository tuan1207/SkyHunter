System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, AudioClip, AudioSource, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, Audio;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Audio", Audio = (_dec = ccclass('Audio'), _dec2 = property(AudioClip), _dec3 = property(AudioSource), _dec4 = property(AudioSource), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class Audio extends Component {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=3da7808f6300f790d4e4e0f21daed7c47f11d107.js.map