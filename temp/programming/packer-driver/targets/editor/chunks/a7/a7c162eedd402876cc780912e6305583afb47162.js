        ...
        spawnTurn1() {
          ...
          const intervalId = setInterval(() => {
            ...
            if (i >= this.enemyWave1.length) {
              clearInterval(intervalId); // Dừng vòng lặp nếu i vượt quá độ dài của mảng
            ...
            for (let j = 0; j < 5; j++) {
              ...
              prefabInstance.parent = this.node; // Các điều kiện setWorldPosition ở đây
...
//# sourceMappingURL=a7c162eedd402876cc780912e6305583afb47162.js.map