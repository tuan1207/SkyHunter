    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        constructor(...args) {
          ...
          this.enemyVelos = [new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10), new Vec2(0, -10)];
          this.enemyPos = [new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10), new Vec3(0, -10)];
        }
        ...
        spawn() {
          // this.scheduleOnce(this.countEle, 6); 
          let bulletPrefab0 = this.enemyWave1[0];

          for (let j = 0; j < 5; j++) {
            let prefabInstance = instantiate(bulletPrefab0);
            prefabInstance.getComponent(RigidBody2D).linearVelocity = this.enemyVelos[this.countElement];
...
//# sourceMappingURL=a7233e7903f14ef8c0af4da6cedcd26857890157.js.map