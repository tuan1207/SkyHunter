    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec(_class = (_class2 = class GameCtrl extends Component {
        constructor(...args) {
          ...
          new Vec3(50, 700), //turn 2
          new Vec3(50, 560), //turn 4
          new Vec3(50, 270), //turn 6
          new Vec3(1200, 560), //turn 8
          new Vec3(1200, 270), //turn 9
          new Vec3(1200, 700) //turn 10
          ];
        }
          ...
          if (i < this.enemyWave1.length) {
            ...
            for (let j = 0; j < 1; j++) {
              ...
              if (enemyPre.name.endsWith('_0')) {
                prefabInstance.setWorldPosition(this.listPos[0]);
              }

              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.listPos[1]);
              }
              ...
              if (enemyPre.name.endsWith('_3')) {
                prefabInstance.setWorldPosition(this.listPos[2]);
              }
              ...
              if (enemyPre.name.endsWith('_5')) {
                prefabInstance.setWorldPosition(this.listPos[3]);
              }
              ...
              if (enemyPre.name.endsWith('_7')) {
                prefabInstance.setWorldPosition(this.listPos[4]);
              }

              if (enemyPre.name.endsWith('_8')) {
                prefabInstance.setWorldPosition(this.listPos[5]);
              }

              if (enemyPre.name.endsWith('_9')) {
                prefabInstance.setWorldPosition(this.listPos[6]);
              }
            }
          } else {
            return;
...
//# sourceMappingURL=000e4a8071d831fc69aa8425f6f43b36c637444a.js.map