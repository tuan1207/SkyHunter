            ...
            for (let i = 0; i < this.listBulletB3.length; i++) {
              ...
              for (let j = 0; j < 5; j++) {
                ...
                if (enemyPre.name.endsWith('_0') || enemyPre.name.endsWith('_1') || enemyPre.name.endsWith('_2') || enemyPre.name.endsWith('_3') || enemyPre.name.endsWith('_4')) {
                  prefabInstance.setWorldPosition(this.node.worldPosition.x - 210, this.node.worldPosition.y - 130, this.node.worldPosition.z);
                }
...
//# sourceMappingURL=a029a839610d4a2769840975df20e59650290197.js.map