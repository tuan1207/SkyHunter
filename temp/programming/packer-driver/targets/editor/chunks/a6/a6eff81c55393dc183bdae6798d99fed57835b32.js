    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(deltaTime) {
          ...
          console.log(this.listPos.length); // let distance = math.Vec3.distance(this.VecY, this.stickPos);
          // let posX = this.node.position.x + distance * 0.05;
          // let posY = this.node.position.y + distance * 0.05;
        ...
        moveRandom() {
          ...
          //     return; // Nếu không cần di chuyển thì dừng lại
          // }
          this.schedule(this.randomX = math.random() * (0 - 1000) + 500, 6, macro.REPEAT_FOREVER, 0);
          this.schedule(this.randomY = math.random() * (0 - 1000) + 500, 6, macro.REPEAT_FOREVER, 0); // const randomX = math.random() * (0 - 1000) + 500;
          // const randomY = math.random() * (200 - 600) + 200;

          const randomPosition = new Vec3(this.randomX, this.randomY); // this.listPos.push(randomPosition);

          console.log(randomPosition); // const distance = Vec3.distance(this.node.position, randomPosition);
...
//# sourceMappingURL=a6eff81c55393dc183bdae6798d99fed57835b32.js.map