    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          let distance = this.Pos.distance(this.VecY); // let distance = math.Vec3.distance(this.VecY, this.Pos);

          console.log(distance);
          console.log(this.Pos.x);
          let posX = this.plane.position.x + direction.x * distance * 0.1;
          let posY = this.plane.position.y + direction.y * distance * 0.1;
...
//# sourceMappingURL=4e3ccf1d41017f6a8412bd91a38c3f8073a4473f.js.map