    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        constructor(...args) {
          ...
          this.spawnList = [this.spawnTurn1(0), this.spawnTurn2(0), this.spawnTurn3(0)];
        ...
        spawnLoop(index) {
          if (index >= this.spawnList.length) {
            this.spawnLoop(0);
          }

          console.log('da spawn'); // Gọi hàm spawnTurn tương ứng với chỉ số index

          this.spawnList[index]; // Gọi đệ quy để gọi tiếp hàm spawnTurn tiếp theo sau khi hàm hiện tại hoàn thành

          setTimeout(() => {
            this.spawnLoop(index + 1);
          }, 150000);
        }
...
//# sourceMappingURL=b8e18b074f6bab560b518655250bc6848b065fbf.js.map