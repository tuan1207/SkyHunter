            ...
            for (let i = 0; i < this.listBulletB3.length; i++) {
              ...
              for (let j = 0; j < 5; j++) {
                ...
                if (enemyPre.name.endsWith('_0') || enemyPre.name.endsWith('_1') || enemyPre.name.endsWith('_2') || enemyPre.name.endsWith('_3') || enemyPre.name.endsWith('_4')) {
                  prefabInstance.setWorldPosition(this.node.worldPosition.x - 105, this.node.worldPosition.y - 130, this.node.worldPosition.z);
                }
...
//# sourceMappingURL=a852cf1df26597e8998a72d6253a114f2e45f340.js.map