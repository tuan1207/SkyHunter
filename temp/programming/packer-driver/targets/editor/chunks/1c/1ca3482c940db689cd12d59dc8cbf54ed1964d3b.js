    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        moveRandom() {
          ...
          const randomPosition = new Vec3(this.randomX, this.randomY);
          this.listPos.push(randomPosition);
...
//# sourceMappingURL=1ca3482c940db689cd12d59dc8cbf54ed1964d3b.js.map