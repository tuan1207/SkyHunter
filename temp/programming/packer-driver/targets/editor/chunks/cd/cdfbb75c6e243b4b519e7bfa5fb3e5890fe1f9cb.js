System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Collider2D, Contact2DType, math, Vec3, tween, Prefab, instantiate, macro, Animation, GameCtrl, Plane, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, Boss;
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = class Boss extends Component {
        ...
        updateHealthBar() {
          if ((_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            ...
            (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
              error: Error()
            }), GameCtrl) : GameCtrl).instance.healthBar[0].progress = this.currentHealth / this.maxHealth;
          }
        }
...
//# sourceMappingURL=cdfbb75c6e243b4b519e7bfa5fb3e5890fe1f9cb.js.map