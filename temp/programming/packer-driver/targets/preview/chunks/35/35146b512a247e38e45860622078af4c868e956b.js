      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet(newX) {
          ...
          for (var i = 0; i < this.listBullet.length; i++) {
            ...
            var newPosition = this.Plane.parent.getWorldPosition(); // Lấy vị trí thế giới hiện tại của nút

            newPosition.x = newX;
            prefabInstance.setWorldPosition(newPosition);
          }
        }
...
//# sourceMappingURL=35146b512a247e38e45860622078af4c868e956b.js.map