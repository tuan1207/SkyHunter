    ...
    execute: function () {
      ...
      _export("AudioToggle", AudioToggle = (_dec = ccclass('AudioToggle'), _dec2 = property(AudioClip), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(AudioSource), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(AudioSource), _dec(_class = (_class2 = (_class3 = class AudioToggle extends Component {
        ...
        updateUI() {
          ...
          var savedAStatus = (_sys$localStorage$get = sys.localStorage.getItem('audioStatus')) != null ? _sys$localStorage$get : 'on';
          ...
          var savedMStatus = (_sys$localStorage$get2 = sys.localStorage.getItem('musicStatus')) != null ? _sys$localStorage$get2 : 'on';
...
//# sourceMappingURL=35f78feb1cc9a2b2640115a44ab790bd489a1106.js.map