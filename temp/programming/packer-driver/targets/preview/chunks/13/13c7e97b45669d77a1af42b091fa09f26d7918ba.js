System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, Collider2D, Contact2DType, Prefab, instantiate, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Bullet;
      ...
      _export("Bullet", Bullet = (_dec = ccclass('Bullet'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Bullet extends Component {
        ...
        turn0() {
          if (this.node.name == 'bullet0' || this.node.name == 'rocket') {
            this.posX = this.node.parent.position.x;
            this.posY = this.node.parent.position.y;
...
//# sourceMappingURL=13c7e97b45669d77a1af42b091fa09f26d7918ba.js.map