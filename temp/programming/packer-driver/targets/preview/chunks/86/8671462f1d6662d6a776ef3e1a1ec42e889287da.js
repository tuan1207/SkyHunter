System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Canvas, Component, director, game, Node, Plane, GameCtrl, AudioToggle, Boss, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, ButtonPlayScene;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Button', 'Canvas', 'Component', 'director', 'Game', 'game', 'Node', 'tween', 'UITransform', 'Vec3']);
      ...
      _export("ButtonPlayScene", ButtonPlayScene = (_dec = ccclass('ButtonPlayScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Node), _dec7 = property(Canvas), _dec(_class = (_class2 = class ButtonPlayScene extends Component {
        constructor() {
          super(...arguments);
        ...
        Pause() {
          ...
          (_crd && Plane === void 0 ? (_reportPossibleCrUseOfPlane({
            error: Error()
          }), Plane) : Plane).instance.moveEnable = false; // Boss.instance.isMoving = false;

          (_crd && Boss === void 0 ? (_reportPossibleCrUseOfBoss({
            error: Error()
          }), Boss) : Boss).instance.moveRandom.call(game.pause());
        }
        ...
        Resume() {
          ...
          this.pauseNode.active = false; // Boss.instance.isMoving = true;
        }
...
//# sourceMappingURL=8671462f1d6662d6a776ef3e1a1ec42e889287da.js.map