    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec(_class = (_class2 = class GameCtrl extends Component {
        constructor() {
          ...
          this.listPos = [new Vec3(640, 720), //turn 1, 3, 5, 7
          ...
          if (i < this.enemyWave1.length) {
            ...
            for (var j = 0; j < 1; j++) {
              ...
              if (enemyPre.name.endsWith('_0')) {
                // prefabInstance.setWorldPosition(this.node.position.x + 640, this.node.position.y, this.node.position.z);
                prefabInstance.setWorldPosition(this.listPos[0].x + newX, this.listPos[0].y, this.listPos[0].z);
              }

              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.listPos[1].x - 100 * (0 + j), this.listPos[1].y + 60 * (j + 1), 0);
              }
...
//# sourceMappingURL=86ae786d366918cb8fe6ae5d5506b941bfcc51b5.js.map