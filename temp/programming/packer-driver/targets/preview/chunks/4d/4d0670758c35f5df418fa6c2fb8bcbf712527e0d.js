    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        countAngleStick(event, dt) {
          var angle = event.detail.angle; // Góc quay của joystick

          var distance = event.detail.distance; // Khoảng cách từ tâm của joystick đến điểm đang chạm
...
//# sourceMappingURL=4d0670758c35f5df418fa6c2fb8bcbf712527e0d.js.map