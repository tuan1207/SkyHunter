        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (other.name === 'ItemB') {
            ...
            this.scheduleOnce(() => {
              ...
              (_this$listItemB = this.listItemB) == null ? void 0 : _this$listItemB.push(other);
            });
            this.scheduleOnce(() => {
              other.destroy();
            });
          ...
          if (other.name === 'ItemR') {
            ...
            this.scheduleOnce(() => {
              ...
              (_this$listItemR = this.listItemR) == null ? void 0 : _this$listItemR.push(other);
            });
            this.scheduleOnce(() => {
              other.destroy();
            });
...
//# sourceMappingURL=291ded46e44a498ca01f62dbbe26f3987b1ee6b9.js.map