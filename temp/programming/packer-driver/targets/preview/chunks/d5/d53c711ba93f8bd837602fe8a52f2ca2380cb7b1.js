        ...
        turnSpawn() {
          for (var i = 0; i < this.enemyWave1.length; i++) {
            for (var j = 0; j < 5; j++) {
              ...
              var offsetX = 120 * (i - 2); // Điều chỉnh khoảng cách giữa các vật thể

              var offsetY = 60 * j; // Điều chỉnh khoảng cách giữa các hàng của các vật thể

              prefabInstance.setWorldPosition(this.node.worldPosition.x + offsetX, this.node.worldPosition.y + 60 + offsetY, this.node.worldPosition.z);
...
//# sourceMappingURL=d53c711ba93f8bd837602fe8a52f2ca2380cb7b1.js.map