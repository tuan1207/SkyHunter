    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        ...
        onLoad() {
          ...
          this.toggleEnemyWave1Spawning(true); // console.log(this.enemyWave1.length);
        ...
        toggleEnemyWave1Spawning(canSpawn) {
          canSpawn = this.spawnEnabled;

          if (canSpawn) {
            var i = 0;
            var spawnInterval = setInterval(() => {
              if (!this.checkTurn1 || !this.spawnEnabled || i >= this.enemyWave1.length) {
        ...
        } // toggleEnemyWave1Spawning(canSpawn: boolean) {
        //     this.spawnEnabled = canSpawn;
        //     if (canSpawn) {
        //         this.spawnTurn1(); // Bắt đầu hoặc tiếp tục spawn nếu canSpawn là true
        //     }
        // }
...
//# sourceMappingURL=23c22593e1d7abb334e6b9c0e2c2fd09b819d9e6.js.map