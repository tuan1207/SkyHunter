    ...
    execute: function () {
      ...
      _export("Helicopter", Helicopter = (_dec = ccclass('Helicopter'), _dec(_class = (_class2 = class Helicopter extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          this.spawnItemPos = selfCollider.node.position; // this.scheduleOnce(() =>{otherCollider.node.destroy()} );
...
//# sourceMappingURL=78790740d49ffbdc24ff3ec8d41bce4b05211d6a.js.map