    ...
    execute: function () {
      ...
      _export("Helicopter", Helicopter = (_dec = ccclass('Helicopter'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Helicopter extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          if (this.contacted) return; // Đặt biến cục bộ để kiểm soát việc gọi hàm spawnItem

          var contacted = true; // Xóa otherCollider.node một lần

          this.scheduleOnce(() => {
            otherCollider.node.destroy();
          }); // Lưu vị trí spawnItem

          this.spawnItemPos = selfCollider.node.position; // Xóa selfCollider.node một lần

          this.scheduleOnce(() => {
            selfCollider.node.destroy();
          }); // Gọi hàm spawnItem một lần
          ...
          }); // Đặt biến cục bộ thành false để đảm bảo rằng spawnItem chỉ được gọi một lần
...
//# sourceMappingURL=3774aa30d8edadc16904662f11c4ec190c3dd5b0.js.map