            ...
            for (var _i = 0; _i < this.listBulletB3.length; _i++) {
              ...
              for (var j = 0; j < 5; j++) {
                ...
                if (_enemyPre.name.endsWith('_0') || _enemyPre.name.endsWith('_1')) {
                  this.schedule(_prefabInstance.setWorldPosition(this.node.worldPosition.x - 50, this.node.worldPosition.y, this.node.worldPosition.z), 0.5, j, 0); // prefabInstance.setWorldPosition(this.node.worldPosition.x - 50, this.node.worldPosition.y, this.node.worldPosition.z);
                }

                if (_enemyPre.name.endsWith('_2') || _enemyPre.name.endsWith('_3')) {
                  _prefabInstance.setWorldPosition(this.node.worldPosition.x + 50, this.node.worldPosition.y, this.node.worldPosition.z);
                }
              }
            }
          }
...
//# sourceMappingURL=196a3ce947b90e177391905fec7f549bf3858a2f.js.map