System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Canvas, Component, director, game, Node, AudioToggle, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _class3, _crd, ccclass, property, ButtonPlayScene;
      ...
      _export("ButtonPlayScene", ButtonPlayScene = (_dec = ccclass('ButtonPlayScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Node), _dec7 = property(Canvas), _dec(_class = (_class2 = (_class3 = class ButtonPlayScene extends Component {
        ...
        Pause() {
          (_crd && AudioToggle === void 0 ? (_reportPossibleCrUseOfAudioToggle({
            error: Error()
          }), AudioToggle) : AudioToggle).instance.onAudioQueue(2); // this.spawnEnabled = false;
          // this.scheduleOnce(() => {this.pauseNode.active = true;});
          // this.scheduleOnce(() => {this.moveEnable = false;});
          // console.log(this.spawnEnabled);
...
//# sourceMappingURL=196cb79bebdd5893fe53805a63063ed6ab03f16a.js.map