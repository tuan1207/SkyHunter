    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        constructor() {
          ...
          new Vec2(0, 0), new Vec2(10.6, -10.6), //4
          new Vec2(0, 0), new Vec2(0, -15), //5
          new Vec2(0, 0), new Vec2(-10.6, -10.6), //6
          new Vec2(0, 0), new Vec2(-15, 0), //7
          new Vec2(0, 0), new Vec2(-10.6, 10.6), //8
          new Vec2(0, 0)];
        }
...
//# sourceMappingURL=d2179e38a70a516d58464a6cfdcb5926723e56c0.js.map