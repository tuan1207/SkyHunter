System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Collider2D, Contact2DType, Vec3, tween, Prefab, instantiate, macro, Animation, GameCtrl, Plane, AudioToggle, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, Boss;
    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        moveRandom() {
          ...
          var randomX = Math.random() * (1000 - -1000) - 1000; // Random x position between -1000 and 1000

          var randomY = Math.random() * (600 - 200) + 200; // Random y position between 200 and 600

          var randomPosition = new Vec3(randomX, randomY);
          var distance = Vec3.distance(this.node.position, randomPosition);
          var duration = distance / this.speed; // Move to the random position

          this.moveTo(randomPosition, duration);
        }

        moveTo(position, duration) {
          // Di chuyển đối tượng đến vị trí được chỉ định trong một khoảng thời gian
          tween(this.node).to(duration, {
            position: position
          }).call(() => {
            // Sau khi hoàn thành di chuyển, lên lịch di chuyển tiếp theo
            setTimeout(() => {
              this.moveRandom();
            }, 5000); // Lên lịch di chuyển ngẫu nhiên sau 5 giây
          }).start();
        }
...
//# sourceMappingURL=9ee772fe2d3dba32d56955bda5fb32f095c2eaa3.js.map