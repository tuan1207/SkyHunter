System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, Vec3, instantiate, Label, ProgressBar, sys, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _class3, _crd, ccclass, property, GameCtrl;
          ...
          if (!this.checkTurn1) {
            ...
            if (i < this.enemyWave1.length) {
              ...
              var _loop = function _loop() {
                var enemyPre = _this.enemyWave1[i];
                var prefabInstance = instantiate(enemyPre);
                prefabInstance.parent = _this.node;

                switch (true) {
                  case enemyPre.name.endsWith('_0'):
                    prefabInstance.setWorldPosition(_this.listPos[0].x + 120 * (j - 2), _this.listPos[0].y, _this.listPos[0].z);
                    break;

                  case enemyPre.name.endsWith('_1'):
                    prefabInstance.setWorldPosition(_this.listPos[1].x - 100 * (0 + j), _this.listPos[1].y + 60 * (j + 1), _this.listPos[0].z);
                    break;

                  case enemyPre.name.endsWith('_2'):
                    prefabInstance.setWorldPosition(_this.listPos[0].x, _this.listPos[0].y + 120 * (0 + j), _this.listPos[0].z);
                    break;

                  case enemyPre.name.endsWith('_3'):
                    prefabInstance.setWorldPosition(_this.listPos[2].x + 140 * (j - 2), _this.listPos[2].y, _this.listPos[2].z);
                    break;
                  ...
                  case enemyPre.name.endsWith('_5'):
                    prefabInstance.setWorldPosition(_this.listPos[3].x + 140 * (j - 2), _this.listPos[3].y, _this.listPos[3].z);
                    break;
                  ...
                  case enemyPre.name.endsWith('_7'):
                    prefabInstance.setWorldPosition(_this.listPos[4].x + 140 * (j - 2), _this.listPos[4].y, _this.listPos[4].z);
                    break;

                  case enemyPre.name.endsWith('_8'):
                    prefabInstance.setWorldPosition(_this.listPos[5].x + 140 * (j - 2), _this.listPos[5].y, _this.listPos[5].z);
                    break;

                  case enemyPre.name.endsWith('_9'):
                    prefabInstance.setWorldPosition(_this.listPos[6].x + 100 * (0 + j), _this.listPos[6].y + 60 * (j + 1), _this.listPos[6].z);
                    break;
...
//# sourceMappingURL=0d0fe9eb69e9a5e6ef21709735f719647b2e7b8a.js.map