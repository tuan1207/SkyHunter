      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(dt) {
          ...
          if (distance > 1) {
            ...
            var posX = this.node.position.x + direction.x * distance * 0.05;
            var posY = this.node.position.y + direction.y * distance * 0.05;
...
//# sourceMappingURL=8b064ea5254e9ed5a1406215290455edb847cef8.js.map