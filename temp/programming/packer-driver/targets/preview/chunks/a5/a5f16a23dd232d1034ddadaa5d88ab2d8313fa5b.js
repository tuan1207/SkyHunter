    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Enemy extends Component {
        ...
        enemyMove() {
          ...
          switch ((_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
          }), GameCtrl) : GameCtrl).instance.countElement) {
            case 0:
              this.posX = this.node.position.x;
              this.posY = this.node.position.y;
              this.posY -= this.bulletSpeed * 0.75;
              var posBullet0 = new Vec3(this.posX, this.posY);
            ...
            case 1:
              ...
              var posBullet1 = new Vec3(this.posX, this.posY);
            ...
            case 2:
              ...
              var posBullet2 = new Vec3(this.posX, this.posY);
            ...
            case 3:
              ...
              this.posY = this.node.position.y;
              this.posX += this.bulletSpeed * 0.75;
              var posBullet3 = new Vec3(this.posX, this.posY);
            ...
            case 4:
              ...
              var posBullet4 = new Vec3(this.posX, this.posY);
            ...
            case 5:
              ...
              var posBullet5 = new Vec3(this.posX, this.posY);
            ...
            case 6:
              ...
              var posBullet6 = new Vec3(this.posX, this.posY);
            ...
            case 7:
              ...
              this.posY = this.node.position.y;
              this.posX -= this.bulletSpeed;
              var posBullet7 = new Vec3(this.posX, this.posY);
            ...
            case 8:
              ...
              var posBullet8 = new Vec3(this.posX, this.posY);
            ...
            case 9:
              ...
              this.posX -= this.bulletSpeed * 0.75;
              this.posY -= this.bulletSpeed * 0.5;
              var posBullet9 = new Vec3(this.posX, this.posY);
...
//# sourceMappingURL=a5f16a23dd232d1034ddadaa5d88ab2d8313fa5b.js.map