System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, math, misc, Node, UITransform, Vec3, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, JoyStick;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onLoad() {
          JoyStick.instance = this; // this.Stick.setPosition(new Vec3(0, 0));
        ...
        onStickMove(event, dt) {
          ...
          var angle = this.Stick.angle; // Góc quay của joystick

          var distance = math.Vec3.distance(this.VecY, this.Pos); // Khoảng cách từ tâm của joystick đến điểm đang chạm
        ...
        onStickEnd(event) {// this.Stick.setPosition(new Vec3(0, 0));
        }
...
//# sourceMappingURL=a54b640d212b04cb6080093c5e2315ae34f949f2.js.map