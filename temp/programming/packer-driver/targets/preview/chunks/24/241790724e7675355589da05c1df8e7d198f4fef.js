          ...
          if (this.node.name === 'boss003') {
            for (var _i = 0; _i < this.listBulletB3.length; _i++) {
              ...
              var _loop = function _loop() {
                ...
                var enemyPre = _this.listBulletB3[_i];
                var prefabInstance = instantiate(enemyPre);
                prefabInstance.parent = _this.node.parent;

                if (enemyPre.name.endsWith('_0') || enemyPre.name.endsWith('_1')) {
                  _this.scheduleOnce(() => {
                    prefabInstance.setWorldPosition(_this.node.worldPosition.x - 50, _this.node.worldPosition.y, _this.node.worldPosition.z);
                  }, j + 0.5); // prefabInstance.setWorldPosition(this.node.worldPosition.x - 50, this.node.worldPosition.y, this.node.worldPosition.z);
...
//# sourceMappingURL=241790724e7675355589da05c1df8e7d198f4fef.js.map