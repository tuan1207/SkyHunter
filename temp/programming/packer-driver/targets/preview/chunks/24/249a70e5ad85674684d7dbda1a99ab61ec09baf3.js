            ...
            for (var _i = 0; _i < this.listBulletB3.length; _i++) {
              ...
              for (var j = 0; j < 5; j++) {
                ...
                if (_enemyPre.name.endsWith('_0') || _enemyPre.name.endsWith('_1') || _enemyPre.name.endsWith('_2') || _enemyPre.name.endsWith('_3') || _enemyPre.name.endsWith('_4')) {
                  _prefabInstance.setWorldPosition(this.node.worldPosition.x - 210, this.node.worldPosition.y - 130, this.node.worldPosition.z);
                }
...
//# sourceMappingURL=249a70e5ad85674684d7dbda1a99ab61ec09baf3.js.map