System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Node, input, Input, KeyCode, Vec3, Collider2D, Contact2DType, Animation, Prefab, macro, GameCtrl, AudioToggle, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _crd, ccclass, property, Plane;
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (other.name.startsWith('enemy')) {
            ...
            }, 4000); // this.scheduleOnce(() => {this.countCont.push(other)});/
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 0) {
            ...
            prefabInstance0.parent = this.bullet.parent;
          ...
          if (this.listItemB.length === 1) {
            for (var j = 0; j < 3; j++) {
              ...
              prefabInstance.parent = this.bullet.parent;
          ...
          if (this.listItemB.length >= 2) {
            for (var _j = 0; _j < 5; _j++) {
              ...
              _prefabInstance.parent = this.bullet.parent;
        ...
        spawnRocket() {
          ...
          if (this.listItemR.length >= 1) {
            ...
            prefabInstance5.parent = this.bullet.parent;
            ...
            prefabInstance6.parent = this.bullet.parent;
...
//# sourceMappingURL=c09599267fa0c0edfd79d6d084799f805ad62238.js.map