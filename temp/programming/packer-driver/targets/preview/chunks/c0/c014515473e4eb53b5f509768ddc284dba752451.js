    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          var distance = math.Vec3.distance(this.VecY, this.Pos); // Lưu trữ hướng di chuyển của stick trước đó
          ...
          var posY = this.plane.position.y + direction.y * distance * 0.05; // Cập nhật vị trí của mặt phẳng
...
//# sourceMappingURL=c014515473e4eb53b5f509768ddc284dba752451.js.map