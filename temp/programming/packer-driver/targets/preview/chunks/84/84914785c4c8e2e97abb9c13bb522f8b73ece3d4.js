            ...
            for (var _i = 0; _i < this.listBulletB3.length; _i++) {
              ...
              var _loop = function _loop() {
                ...
                if (enemyPre.name.endsWith('_0') || enemyPre.name.endsWith('_1')) {
                  ...
                  _this.scheduleOnce(() => {
                    prefabInstance.setWorldPosition(_this.node.worldPosition.x - 50, _this.node.worldPosition.y, _this.node.worldPosition.z);
                  }, 2); // prefabInstance.setWorldPosition(this.node.worldPosition.x - 50, this.node.worldPosition.y, this.node.worldPosition.z);
...
//# sourceMappingURL=84914785c4c8e2e97abb9c13bb522f8b73ece3d4.js.map