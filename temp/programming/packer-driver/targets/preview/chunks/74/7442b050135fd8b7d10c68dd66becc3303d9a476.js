    ...
    execute: function () {
      ...
      _export("Camera", Camera = (_dec = ccclass('Camera'), _dec2 = property(CameraComponent), _dec3 = property(Canvas), _dec(_class = (_class2 = class Camera extends Component {
        ...
        setCameraAspectRatio() {
          ...
          var resolutionWidth = this.cavas.node.width;
          var resolutionHeight = this.cavas.node.height; // Calculate the aspect ratio of the screen

          var screenAspectRatio = resolutionWidth / resolutionHeight; // Set the camera's aspect ratio based on the screen aspect ratio
...
//# sourceMappingURL=7442b050135fd8b7d10c68dd66becc3303d9a476.js.map