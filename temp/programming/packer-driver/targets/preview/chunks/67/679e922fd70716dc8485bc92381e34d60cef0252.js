    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        constructor() {
          ...
          this.bulletVelos = [new Vec2(0, 15), //1
          new Vec2(5.3, 12.8), new Vec2(10.6, 10.6), //2
          new Vec2(12.8, 5.3), new Vec2(15, 0), //3
          new Vec2(12.8, -5.3), new Vec2(10.6, -10.6), //4
          new Vec2(5.3, -12.8), new Vec2(0, -15), //5
          new Vec2(-5.3, -12.8), new Vec2(-10.6, -10.6), //6
          new Vec2(-12.8, -5.3), new Vec2(-15, 0), //7
...
//# sourceMappingURL=679e922fd70716dc8485bc92381e34d60cef0252.js.map