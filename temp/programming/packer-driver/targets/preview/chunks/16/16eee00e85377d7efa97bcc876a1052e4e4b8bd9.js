      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 0) {
            ...
            prefabInstance0.parent = this.node; // prefabInstance0.setWorldPosition(this.node.worldPosition.x, this.node.worldPosition.y+60, this.node.worldPosition.z);
...
//# sourceMappingURL=16eee00e85377d7efa97bcc876a1052e4e4b8bd9.js.map