          ...
          if (i < this.enemyWave1.length) {
            ...
            for (var j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x - 280 - 60 * (j + 2), this.node.worldPosition.y + 120 * (j - 2), this.node.worldPosition.z);
              }
...
//# sourceMappingURL=16a2259e1b3375cb3174d47f29dc2b290793e98d.js.map