      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          for (var i = 0; i < this.listBullet.length; i++) {
            ...
            var posXPlane = Plane.instance.Plane.position.x;
            var posYPlane = Plane.instance.Plane.position.y;
            var posBullet = new Vec3(posXPlane, posYPlane + 60);
            var prefabInstance = instantiate(bulletPrefab);
            prefabInstance.setPosition(posBullet);
            this.node.addChild(prefabInstance); // let prefabInstance = instantiate(bulletPrefab);
...
//# sourceMappingURL=b6bd5887db3ac8369c3dcb7db4aa075d992ac60d.js.map