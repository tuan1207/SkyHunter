    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec(_class = (_class2 = class GameCtrl extends Component {
        constructor() {
          ...
          this.listPos = [new Vec3(640, 760), new Vec3(-50, 760), new Vec3(640, 760), new Vec3(-50, 560), new Vec3(-50, 270), new Vec3(640, 760), new Vec3(640, 760)];
        }
...
//# sourceMappingURL=8d2e1c6ab62dbd94bc364476c7eb1d087a6d4d9c.js.map