    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        constructor() {
          ...
          this.bulletVelos = [new Vec2(0, 13.85), //1
          new Vec2(5.3, 12.8), new Vec2(10.6, 10.6), //2
          new Vec2(12.8, 5.3), new Vec2(13.85, 0), //3
          new Vec2(12.8, -5.3), new Vec2(10.6, -10.6), //4
          new Vec2(5.3, -12.8), new Vec2(0, -13.85), //5
          new Vec2(-5.3, -12.8), new Vec2(-10.6, -10.6), //6
          new Vec2(-12.8, -5.3), new Vec2(-13.85, 0), //7
          new Vec2(-12.8, 5.3), new Vec2(-10.6, 10.6), //8
          new Vec2(-5.3, 12.8)];
        }
        ...
        spawnBullet() {
          ...
          if (this.node.name === 'boss003') {
            for (var _i = 0; _i < this.bulletVelos.length; _i++) {
              var _enemyPre = this.bulletE;

              for (var j = 0; j < 3; j++) {
                var _prefabInstance = instantiate(_enemyPre);

                _prefabInstance.parent = this.node.parent;
                _prefabInstance.getComponent(RigidBody2D).linearVelocity = this.bulletVelos[_i];
                ...
                if (j === 2) {
                  _prefabInstance.setWorldPosition(this.node.worldPosition.x, this.node.worldPosition.y, this.node.worldPosition.z);
                }
              }
            }
          }
...
//# sourceMappingURL=7328a3add63ca021f1252e61eda2f6e0554dced2.js.map