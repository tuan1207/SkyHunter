          ...
          if (i < this.enemyWave1.length) {
            ...
            for (var j = 0; j < 5; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x - 560 - 120 * (j + 2), this.node.worldPosition.y + 120 * (j - 2), this.node.worldPosition.z);
              }
...
//# sourceMappingURL=1764a945881c26d565d7f2895485d4a7e5da1754.js.map