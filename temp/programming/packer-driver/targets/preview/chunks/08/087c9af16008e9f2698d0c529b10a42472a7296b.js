      ...
      _export("BulletE", BulletE = (_dec = ccclass('BulletE'), _dec(_class = class BulletE extends Component {
        ...
        bulletMove() {
          if (this.node.name == 'enemyb0') {
            ...
            var posEnd = new Vec3(posXEnd, posYEnd);
            var distance = Vec3.distance(this.node.position, posEnd);
...
//# sourceMappingURL=087c9af16008e9f2698d0c529b10a42472a7296b.js.map