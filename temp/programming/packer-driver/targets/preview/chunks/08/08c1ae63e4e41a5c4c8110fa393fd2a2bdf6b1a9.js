        ...
        spawnTurn1(i) {
          ...
          if (i < this.enemyWave1.length) {
            ...
            for (var j = 0; j < 5; j++) {
              ...
              if (i = 0) prefabInstance.setWorldPosition(this.listPos[0].x + 120 * (j - 2), this.listPos[0].y, this.listPos[0].z);
            }
          }
        }
...
//# sourceMappingURL=08c1ae63e4e41a5c4c8110fa393fd2a2bdf6b1a9.js.map