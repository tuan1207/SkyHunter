        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 1) {
            for (var i = 0; i < 3; i++) {
              ...
              if (veloPre) {
                veloPre.linearVelocity = this.bulletPositions[i];
              }
          ...
          if (this.listItemB.length >= 2) {
            for (var _i = 0; _i < 5; _i++) {
              ...
              var _veloPre = _prefabInstance2.getComponent(RigidBody2D);

              if (_veloPre) {
                _veloPre.linearVelocity = this.bulletPositions[_i];
              }
...
//# sourceMappingURL=65b7179f7cea59ea7ae6151200aa6e5a7f0bdbc0.js.map