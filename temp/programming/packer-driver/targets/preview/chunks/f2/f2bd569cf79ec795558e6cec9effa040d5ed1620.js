System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Node, input, Input, KeyCode, Vec3, Collider2D, Contact2DType, Animation, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, Plane;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        constructor() {
          super(...arguments);
        ...
        spawnBullet() {
          ...
          for (var i = 0; i < this.listBullet.length; i++) {
            var bulletPrefab = this.listBullet[i];
...
//# sourceMappingURL=f2bd569cf79ec795558e6cec9effa040d5ed1620.js.map