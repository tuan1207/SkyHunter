System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Vec3, instantiate, Plane, Helicopter, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _crd, ccclass, property, GameCtrl;
  ...
  function _reportPossibleCrUseOfHelicopter(extras) {
    _reporterNs.report("Helicopter", "./Helicopter", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Helicopter = _unresolved_3.Helicopter;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        constructor() {
          super(...arguments);
        ...
        start() {
          // this.scheduleOnce(() => {this.spawnTurn1(0)}, 7);
          // this.scheduleOnce(() => {this.spawnTurn2(0)}, 84);
          // this.scheduleOnce(() => {this.spawnTurn3(0)}, 161);
          // this.spawnBoss1();
          // this.spawnBoss3();
          // this.spawnBoss2();
          this.spawnItem(); // this.schedule(this.spawnHeli, 1, macro.REPEAT_FOREVER, 0);
        }
        ...
        spawnItem() {
          ...
          var randomPrefab = this.items[randomIndex];
          var prefabInstance = instantiate(randomPrefab);
          prefabInstance.setPosition((_crd && Helicopter === void 0 ? (_reportPossibleCrUseOfHelicopter({
            error: Error()
          }), Helicopter) : Helicopter).instance.spawnItemPos);
          this.node.addChild(prefabInstance);
        }
...
//# sourceMappingURL=0a8a55f946a9d43c18e6077159b3b096897adce7.js.map