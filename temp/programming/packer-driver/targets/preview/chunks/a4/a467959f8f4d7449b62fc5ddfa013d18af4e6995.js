    ...
    execute: function () {
      ...
      _export("Helicopter", Helicopter = (_dec = ccclass('Helicopter'), _dec(_class = (_class2 = class Helicopter extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          var randomIndex = Math.floor(Math.random() * (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
          }), GameCtrl) : GameCtrl).instance.items.length);
          var randomPrefab = (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
...
//# sourceMappingURL=a467959f8f4d7449b62fc5ddfa013d18af4e6995.js.map