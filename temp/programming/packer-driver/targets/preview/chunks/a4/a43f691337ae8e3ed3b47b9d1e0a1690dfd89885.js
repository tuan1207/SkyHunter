System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Vec3, instantiate, macro, Helicopter, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _crd, ccclass, property, GameCtrl;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Helicopter = _unresolved_2.Helicopter;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        ...
        update(dt) {
          console.log((_crd && Helicopter === void 0 ? (_reportPossibleCrUseOfHelicopter({
            error: Error()
...
//# sourceMappingURL=a43f691337ae8e3ed3b47b9d1e0a1690dfd89885.js.map