System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Boss1", Boss1 = (_dec4 = ccclass('Boss1'), _dec4(_class4 = class Boss1 extends Boss {
        spawnBullet() {
          if (!(_crd && ButtonPlayScene === void 0 ? (_reportPossibleCrUseOfButtonPlayScene({
            error: Error()
          }), ButtonPlayScene) : ButtonPlayScene).instance.spawnEnabled) {
      ...
      _export("Boss2", Boss2 = (_dec5 = ccclass('Boss2'), _dec5(_class5 = class Boss2 extends Boss {}) || _class5));

      _export("Boss3", Boss3 = (_dec6 = ccclass('Boss3'), _dec6(_class6 = class Boss3 extends Boss {
        spawnBullet() {
          if (this.node.name === 'boss003') {
            for (var i = 0; i < this.bulletVelos.length; i++) {
              var enemyPre = this.bulletE;
...
//# sourceMappingURL=1b1cdc2059601086b4cb9a687a7391082e5f0bf3.js.map