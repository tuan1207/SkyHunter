        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (other.name === 'ItemB') {
            ...
            this.scheduleOnce(() => {
              ...
              (_this$listItemB = this.listItemB) == null ? void 0 : _this$listItemB.push(other.name === 'ItemB');
            });
            this.scheduleOnce(() => {
              other.destroy();
            });
          ...
          if (other.name === 'ItemR') {
            ...
            this.scheduleOnce(() => {
              this.listItemR.push(other.name === 'ItemR');
            });
            this.scheduleOnce(() => {
              other.destroy();
            });
          ...
          if (other.name.startsWith('enemy')) {
            ...
            this.scheduleOnce(() => {
              this.listItemR.length = 0;
            });
            this.scheduleOnce(() => {
              this.listItemB.length = 0;
            });
            this.scheduleOnce(() => {
              other.destroy();
            });
...
//# sourceMappingURL=e056bae6ddc5c0a6b607a7db4d679744339c5dd6.js.map