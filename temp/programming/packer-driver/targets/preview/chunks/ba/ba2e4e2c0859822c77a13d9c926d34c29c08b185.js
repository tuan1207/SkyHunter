    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Enemy extends Component {
        constructor() {
          ...
          this.posX = (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
          }), GameCtrl) : GameCtrl).instance.node.parent.worldPosition.x;
          this.posY = (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
          }), GameCtrl) : GameCtrl).instance.node.parent.worldPosition.y;
        }
...
//# sourceMappingURL=ba2e4e2c0859822c77a13d9c926d34c29c08b185.js.map