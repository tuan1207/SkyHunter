System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, math, Node, UITransform, Vec3, Plane, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, JoyStick;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EventTouch', 'math', 'Node', 'UITransform', 'Vec3']);
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        constructor() {
          super(...arguments);
        ...
        countAngleStick() {
          var angleInRadians = Math.acos(this.VecY.dot(this.Pos) / (this.VecY.length() * this.Pos.length()));
          this.angleDeg = math.toDegree(angleInRadians);
        }

        planeMoveByJoyStick(dt) {
          if (this.Pos.x > 0 || this.Pos.y > 0 || 45 < this.angleDeg || this.angleDeg < 90) {
            (_crd && Plane === void 0 ? (_reportPossibleCrUseOfPlane({
              error: Error()
            }), Plane) : Plane).instance.moveRight;
            (_crd && Plane === void 0 ? (_reportPossibleCrUseOfPlane({
              error: Error()
            }), Plane) : Plane).instance.moveUp;
            (_crd && Plane === void 0 ? (_reportPossibleCrUseOfPlane({
              error: Error()
            }), Plane) : Plane).instance.planeMove(dt);
          }
        }
...
//# sourceMappingURL=9af0889a46eb39d293fd6d5c383959f5dd86fe7a.js.map