System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransform, Vec3, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, JoyStick;
    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          var distance = this.Pos.distance(this.VecY); // let distance = math.Vec3.distance(this.VecY, this.Pos);

          console.log(distance);
          console.log(this.Pos.x);
          var posX = this.plane.position.x + direction.x * distance * 0.1;
          var posY = this.plane.position.y + direction.y * distance * 0.1;
          this.plane.setPosition(new Vec3(posX, posY)); // let posX = this.plane.position.x;
...
//# sourceMappingURL=b4ee43c0829f85d134c4f7fc8d91f5cdb29eb3f6.js.map