    ...
    execute: function () {
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        constructor() {
          ...
          this.listItemR = [];
          this.countCont = [];
          this.bulletPositions = [new Vec2(0, 20), new Vec2(-1.5, 19), new Vec2(1.5, 19), new Vec2(-3, 18), new Vec2(3, 18)];
        }
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 0) {
            ...
            prefabInstance.getComponent(RigidBody2D).linearVelocity = this.bulletPositions[0];
          ...
          if (this.listItemB.length === 1) {
            for (var i = 0; i < 3; i++) {
              ...
              _prefabInstance.getComponent(RigidBody2D).linearVelocity = this.bulletPositions[i];
          ...
          if (this.listItemB.length >= 2) {
            for (var _i = 0; _i < 5; _i++) {
              ...
              _prefabInstance2.getComponent(RigidBody2D).linearVelocity = this.bulletPositions[_i];
        ...
        spawnRocket() {
          ...
          if (this.listItemR.length >= 1) {
            ...
            prefabInstance0.getComponent(RigidBody2D).linearVelocity = this.bulletPositions[0];
            ...
            prefabInstance1.getComponent(RigidBody2D).linearVelocity = this.bulletPositions[0];
...
//# sourceMappingURL=69aa036c7e2184e286b31e32a69283f43fb2e7b3.js.map