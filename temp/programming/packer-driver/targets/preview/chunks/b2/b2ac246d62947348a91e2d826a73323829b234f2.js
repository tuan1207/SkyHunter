System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Collider2D, Contact2DType, math, Vec3, Prefab, instantiate, macro, Animation, GameCtrl, AudioToggle, ButtonPlayScene, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, Boss;
    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        start() {
          ...
          this.randomPos(); // this.moveRandom();
        }
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (otherCollider.node.name === 'bullet0' || otherCollider.node.name.startsWith('rocket')) {
        ...
        updateHealthBar() {// if (GameCtrl.instance.healthBar[0]) {
...
//# sourceMappingURL=b2ac246d62947348a91e2d826a73323829b234f2.js.map