    ...
    execute: function () {
      ...
      _export("ButtonPlayScene", ButtonPlayScene = (_dec = ccclass('ButtonPlayScene'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Node), _dec7 = property(Canvas), _dec(_class = (_class2 = (_class3 = class ButtonPlayScene extends Component {
        constructor() {
          ...
          this.countI = (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
        ...
        Pause() {
          ...
          (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
          }), GameCtrl) : GameCtrl).instance.toggleEnemyWave1Spawning(false, this.countI);
          this.scheduleOnce(() => {
        ...
        Resume() {
          ...
          (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
            error: Error()
          }), GameCtrl) : GameCtrl).instance.toggleEnemyWave1Spawning(true, this.countI);
          this.scheduleOnce(() => {
...
//# sourceMappingURL=e606fbea2b97e5731ad89476f0945e7ecad9a689.js.map