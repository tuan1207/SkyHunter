            ...
            for (var _i = 0; _i < this.listBulletB3.length; _i++) {
              ...
              for (var j = 0; j < 5; j++) {
                ...
                if (_enemyPre.name.endsWith('_0') || _enemyPre.name.endsWith('_1') || _enemyPre.name.endsWith('_2') || _enemyPre.name.endsWith('_3') || _enemyPre.name.endsWith('_4')) {
                  _prefabInstance.setWorldPosition(this.node.worldPosition.x - 105, this.node.worldPosition.y - 130, this.node.worldPosition.z);
                }
...
//# sourceMappingURL=f9b273795bdbf0f83a6198e16dab7636c96b29b2.js.map