      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(dt) {
          ...
          if (distance > 1) {
            ...
            var posX = this.node.position.x + direction.x * distance * 0.1;
            var posY = this.node.position.y + direction.y * distance * 0.1;
...
//# sourceMappingURL=0c3131eb20628cba68cf8c13c2504a5c11712180.js.map