  ...
  return {
    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        onLoad() {
          Boss.instance = this; // this.moveRandom();
        }
        ...
        update(deltaTime) {
          ...
          this.moveRandom(); // let distance = math.Vec3.distance(this.VecY, this.stickPos);
        ...
        moveRandom() {
          ...
          this.listPos.push(randomPosition); // const distance = Vec3.distance(this.node.position, randomPosition);
...
//# sourceMappingURL=590dd08bf12d1631888fcfe379330a73d06bdd7d.js.map