    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec(_class = (_class2 = class JoyStick extends Component {
        ...
        onStickMove(event) {
          ...
          var Pos = this.node.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(wp.x, wp.y));
          var stickMag = Pos.length();
          ...
          if (stickMag > this.maxR) {
            Pos.x = Pos.x * this.maxR / stickMag;
            Pos.y = Pos.y * this.maxR / stickMag;
          }
...
//# sourceMappingURL=5915808f214a8143ad07ed09ae3457639b3f8eab.js.map