  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        ...
        start() {
          this.schedule(this.spawnTurn1, 0, macro.REPEAT_FOREVER, 0);
          this.schedule(this.spawnBoss1, 0, macro.REPEAT_FOREVER, 77);
          this.schedule(this.spawnTurn2, 0, macro.REPEAT_FOREVER, 107);
          this.schedule(this.spawnBoss2, 0, macro.REPEAT_FOREVER, 184);
          this.schedule(this.spawnTurn3, 0, macro.REPEAT_FOREVER, 214);
          this.schedule(this.spawnBoss3, 0, macro.REPEAT_FOREVER, 291);
...
//# sourceMappingURL=92173c0c99c2f470937f8b8d54b07342df27f9a8.js.map