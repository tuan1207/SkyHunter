    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        update(dt) {
          ...
          if (distance > 1) {
            // Di chuyển đối tượng theo hướng và tốc độ đã tính toán
            var posX = this.node.position.x + direction.x * distance * 0.005;
            var posY = this.node.position.y + direction.y * distance * 0.005;
            this.node.setPosition(new Vec3(posX, posY));
          } else {
            // Nếu đã đến gần đủ, tạo vị trí ngẫu nhiên mới
            this.randomPos();
          }
        }
...
//# sourceMappingURL=a9787493f11e9e679dcbe1446f040c8188e49c05.js.map