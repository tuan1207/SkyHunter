    ...
    execute: function () {
      ...
      _export("Helicopter", Helicopter = (_dec = ccclass('Helicopter'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Helicopter extends Component {
        constructor() {
          ...
          // Biến để kiểm tra xem item đã được spawn chưa
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          this.spawnItemPos = selfCollider.node.position; // Kiểm tra nếu chưa spawn item thì mới thực hiện spawn
...
//# sourceMappingURL=e82584062b6f0fdda5ff55cf6f0a91fe2e966e38.js.map