      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          for (var i = 0; i < this.listBullet.length; i++) {
            ...
            var prefabInstance = instantiate(bulletPrefab); // prefabInstance.parent = this.node.parent;

            prefabInstance.setPosition(this.node.position);
          }
        }
...
//# sourceMappingURL=c2bb69aa3320a1b2ee054c5a38a5cb07fe609d07.js.map