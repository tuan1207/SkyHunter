    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          var distance = math.Vec3.distance(this.VecY, this.Stick.position); // Khoảng cách từ tâm của joystick đến điểm đang chạm
...
//# sourceMappingURL=4c8ca34fda875a178c409d081c7a2144d934830b.js.map