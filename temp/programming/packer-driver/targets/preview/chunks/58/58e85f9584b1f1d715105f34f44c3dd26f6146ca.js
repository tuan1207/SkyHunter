      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 0) {
            ...
            prefabInstance.getComponent(RigidBody2D).linearVelocity = new Vec2(0, 20);
          ...
          if (this.listItemB.length === 1) {
            var bulletPositions = [new Vec2(-2, 19), // Vị trí cho node đạn thứ nhất
            new Vec2(0, 20), // Vị trí cho node đạn thứ hai
            new Vec2(2, 19) // Vị trí cho node đạn thứ ba
            ];

            for (var i = 0; i < 3; i++) {
              var _prefabInstance = instantiate(bulletPrefab0);

              var veloPre = _prefabInstance.getComponent(RigidBody2D);

              if (veloPre) {
                veloPre.linearVelocity = bulletPositions[i];
              }
            }
          }
          ...
          if (this.listItemB.length >= 2) {
            for (var j = 0; j < 5; j++) {
              ...
              var _prefabInstance2 = instantiate(bulletPrefab);
...
//# sourceMappingURL=58e85f9584b1f1d715105f34f44c3dd26f6146ca.js.map