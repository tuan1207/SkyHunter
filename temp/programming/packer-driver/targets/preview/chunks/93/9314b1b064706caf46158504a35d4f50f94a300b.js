          ...
          if (i < this.enemyWave1.length) {
            ...
            for (var j = 0; j < 1; j++) {
              ...
              if (enemyPre.name.endsWith('_1')) {
                prefabInstance.setWorldPosition(this.node.worldPosition.x - 120 * (j + 2), this.node.worldPosition.y + 20, this.node.worldPosition.z);
              }
...
//# sourceMappingURL=9314b1b064706caf46158504a35d4f50f94a300b.js.map