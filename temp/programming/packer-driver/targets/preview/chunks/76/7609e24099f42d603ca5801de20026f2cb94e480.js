          ...
          if (i < this.enemyWave1.length) {
            ...
            for (var j = 0; j < 1; j++) {
              ...
              if (enemyPre.name.endsWith('_0')) {
                prefabInstance.setWorldPosition(this.listPos[0].x, this.listPos[0].x, this.listPos[0].x);
              } else {
...
//# sourceMappingURL=7609e24099f42d603ca5801de20026f2cb94e480.js.map