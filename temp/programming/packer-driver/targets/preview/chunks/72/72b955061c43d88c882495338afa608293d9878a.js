System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, tween, Vec3, Prefab, instantiate, Collider2D, Contact2DType, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Enemy;
    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Enemy extends Component {
        constructor() {
          ...
          this.posX = this.node.parent.worldPosition.x;
          this.posY = this.node.parent.worldPosition.y;
        }
        ...
        enemyMove() {
          if (this.node.name.endsWith('_0')) {
            ...
            var randomPosition = new Vec3(this.posX, this.posY);
...
//# sourceMappingURL=72b955061c43d88c882495338afa608293d9878a.js.map