      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        moveRandom() {
          ...
          tween(this.node).to(duration, {
            ...
            this.schedule(this.moveRandom(), 6, macro.REPEAT_FOREVER, 0); // Gọi lại moveRandom() để di chuyển đến vị trí mới sau khi hoàn thành tween
          }).start();
        }
...
//# sourceMappingURL=2aec8a660e68013827cb7310dfcace6337836f4d.js.map