    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        ...
        spawn() {
          ...
          var bulletPrefab0 = this.enemyWave1[0];
          ...
          for (var j = 0; j < 5; j++) {
            ...
            switch (this.countElement) {
              ...
              case 2:
                ...
                // }
                var startPoint = new Vec2(0, 320); // Điểm chuyển động theo chiều ngang (200, 0)

                var horizontalPoint = new Vec2(200, 0); // Điểm chuyển động theo chiều dọc (200, -100)

                var verticalPoint = new Vec2(0, 100); // Tạo tween để di chuyển từ điểm xuất phát đến điểm chuyển động theo chiều ngang

                var tween1 = tween().to(1, {
                  position: horizontalPoint
                }); // Tạo tween để di chuyển từ điểm chuyển động theo chiều ngang đến điểm chuyển động theo chiều dọc

                var tween2 = tween().to(1, {
...
//# sourceMappingURL=6138a4993805a9d264c07f3352f98ff46ae243f6.js.map