    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          var distance = math.Vec3.distance(this.VecY, this.Pos); // let distance = math.Vec3.distance(this.VecY, this.Pos);
...
//# sourceMappingURL=ae5c7de9baecff2956230cd8d60e3532934dc0d0.js.map