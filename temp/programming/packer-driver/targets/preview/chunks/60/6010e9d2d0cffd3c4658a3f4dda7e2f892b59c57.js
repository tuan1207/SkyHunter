System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, Collider2D, Contact2DType, Prefab, instantiate, Plane, ButtonPlayScene, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Bullet;
      ...
      _export("Bullet", Bullet = (_dec = ccclass('Bullet'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Bullet extends Component {
        ...
        turn0() {
          ...
          if (this.node.name == 'bullet0' || this.node.name == 'rocket') {
            ...
            this.posY += (_crd && Plane === void 0 ? (_reportPossibleCrUseOfPlane({
              error: Error()
            }), Plane) : Plane).instance.moveSpeed * 0.05;
...
//# sourceMappingURL=6010e9d2d0cffd3c4658a3f4dda7e2f892b59c57.js.map