  ...
  return {
    ...
    execute: function () {
      ...
      _export("BulletEN", BulletEN = (_dec = ccclass('BulletEN'), _dec2 = property(Prefab), _dec(_class = (_class2 = class BulletEN extends Component {
        ...
        bulletE() {
          var direction = Plane.instance.Plane.position.clone().subtract(this.node.position).normalize();
          var distance = math.Vec3.distance(this.node.position, Plane.instance.Plane.position);
...
//# sourceMappingURL=5d11b2e566609ac4d134e17bace4f25d9ad7ede7.js.map