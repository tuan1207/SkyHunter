          ...
          if (otherCollider.node.name.startsWith('bullet') || otherCollider.node.name.startsWith('rocket')) {
            if (this.node.name === 'boss001') {
              ...
              if (this.bulletCont1.length >= 150) {
                ...
                }); // this.scheduleOnce(() => {this.bulletCont2 = []});
                // this.scheduleOnce(() => {GameCtrl.instance.healthBar[1].progress = 1});
              }
            }
            ...
            if (this.node.name === 'boss002') {
              ...
              if (this.bulletCont2.length >= 150) {
                ...
                }); // this.scheduleOnce(() => {this.bulletCont3 = []});
                // this.scheduleOnce(() => {GameCtrl.instance.healthBar[2].progress = 1});
              }
            }
            ...
            if (this.node.name === 'boss003') {
              ...
              if (this.bulletCont3.length >= 150) {
                ...
                }); // this.scheduleOnce(() => {this.bulletCont1 = []});
                // this.scheduleOnce(() => {GameCtrl.instance.healthBar[0].progress = 1});
              }
            }
...
//# sourceMappingURL=71404c836096e00e1e78da62b4ccee258066aa92.js.map