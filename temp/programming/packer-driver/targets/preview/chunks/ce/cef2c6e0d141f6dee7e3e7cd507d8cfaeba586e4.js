    ...
    execute: function () {
      ...
      _export("AudioToggle", AudioToggle = (_dec = ccclass('AudioToggle'), _dec2 = property(AudioClip), _dec3 = property(Toggle), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(AudioSource), _dec7 = property(Toggle), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(AudioSource), _dec(_class = (_class2 = (_class3 = class AudioToggle extends Component {
        ...
        audioTogFunc() {
          ...
          var savedStatus = sys.localStorage.getItem('audioStatus');
          sys.localStorage.setItem('audioStatus', this.audioStatus ? 'off' : 'on');
        ...
        musicTogFunc() {
          ...
          var savedStatus = sys.localStorage.getItem('musicStatus');
          sys.localStorage.setItem('musicStatus', this.musicStatus ? 'off' : 'on');
...
//# sourceMappingURL=cef2c6e0d141f6dee7e3e7cd507d8cfaeba586e4.js.map