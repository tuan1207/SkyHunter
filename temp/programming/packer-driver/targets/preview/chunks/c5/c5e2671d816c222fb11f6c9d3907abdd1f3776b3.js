System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, Vec3, instantiate, Label, ProgressBar, sys, NodePool, ButtonPlayScene, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _class3, _crd, ccclass, property, GameCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameCtrl", GameCtrl = (_dec = ccclass('GameCtrl'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(ProgressBar), _dec(_class = (_class2 = (_class3 = class GameCtrl extends Component {
        ...
        onLoad() {
          GameCtrl.instance = this; // this.schedule(this.spawnTurn1, 7, 9, 0);
          // this.schedule(this.spawnTurn2, 7, 9, 75);

          this.schedule(this.spawnTurn3, 7, 9, 0); // this.scheduleOnce(()=> {this.spawnBoss1()}, 75);
          // this.spawn();
...
//# sourceMappingURL=c5e2671d816c222fb11f6c9d3907abdd1f3776b3.js.map