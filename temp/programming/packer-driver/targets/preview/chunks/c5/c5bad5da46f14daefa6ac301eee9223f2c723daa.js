    ...
    execute: function () {
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        constructor() {
          ...
          this.listItemR = [];
          this.countCont = [];
          this.bulletPositions = [new Vec2(0, 20), new Vec2(-2, 19), new Vec2(2, 19), new Vec2(-4, 18), new Vec2(4, 18)];
        }
...
//# sourceMappingURL=c5bad5da46f14daefa6ac301eee9223f2c723daa.js.map