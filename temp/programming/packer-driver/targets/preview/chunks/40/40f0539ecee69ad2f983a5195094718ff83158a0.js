    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          var angle = math.Vec3.angle(this.Pos, new Vec3(0, 1, 0)); // Góc quay của joystick
          ...
          posX += deltaX * this.moveSpeed;
          posY += deltaY * this.moveSpeed;
...
//# sourceMappingURL=40f0539ecee69ad2f983a5195094718ff83158a0.js.map