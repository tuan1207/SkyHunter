System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Node, input, Input, KeyCode, Vec3, Collider2D, Contact2DType, Animation, Prefab, macro, GameCtrl, AudioToggle, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, Plane;
      ...
      _export("Plane", Plane = (_dec = ccclass('Plane'), _dec2 = property(Node), _dec3 = property(Animation), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = (_class3 = class Plane extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (other.name.startsWith('Laser')) {
            ...
            setTimeout(() => {
              selfCollider.group = 1;
            }, 2000); // this.scheduleOnce(() => {this.countCont.push(other)});
            // this.scheduleOnce(() => this.checkHealth());s
          }
        }
        ...
        spawnBullet() {
          ...
          if (this.listItemB.length === 0) {
            ...
            prefabInstance0.parent = (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
              error: Error()
            }), GameCtrl) : GameCtrl).instance.node;
            prefabInstance0.setWorldPosition((_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
              error: Error()
            }), GameCtrl) : GameCtrl).instance.node.worldPosition.x, (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
              error: Error()
            }), GameCtrl) : GameCtrl).instance.node.worldPosition.y + 60, (_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
              error: Error()
            }), GameCtrl) : GameCtrl).instance.node.worldPosition.z);
          }
...
//# sourceMappingURL=d3ad01d8497eabd9c359afe205031101b2f628b4.js.map