    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        moveRandom() {
          ...
          this.node.setPosition(new Vec3(posX, posY)); // tween(this.node)
          //     .to(duration, { position: randomPosition })
          //     .call(() => {
          //         this.schedule(this.moveRandom, 4, macro.REPEAT_FOREVER, 0); // Gọi lại moveRandom() để di chuyển đến vị trí mới sau khi hoàn thành tween
          //     })
          //     .start();
        }
...
//# sourceMappingURL=d300307fc31aac3c072f80dbfe92df64f28d70d6.js.map