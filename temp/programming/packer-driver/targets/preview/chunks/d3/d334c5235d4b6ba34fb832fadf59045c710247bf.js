            ...
            for (var _i = 0; _i < this.listBulletB3.length; _i++) {
              ...
              for (var j = 0; j < 5; j++) {
                ...
                if (_enemyPre.name.endsWith('_0') || _enemyPre.name.endsWith('_1') || _enemyPre.name.endsWith('_2') || _enemyPre.name.endsWith('_3') || _enemyPre.name.endsWith('_4')) {
                  _prefabInstance.setWorldPosition(this.node.worldPosition.x - 210, this.node.worldPosition.y, this.node.worldPosition.z);
                }
...
//# sourceMappingURL=d334c5235d4b6ba34fb832fadf59045c710247bf.js.map