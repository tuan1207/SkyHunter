System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Collider2D, Contact2DType, math, Vec3, instantiate, Plane, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, BulletEN;
    ...
    execute: function () {
      ...
      _export("BulletEN", BulletEN = (_dec = ccclass('BulletEN'), _dec2 = property(Prefab), _dec(_class = (_class2 = class BulletEN extends Component {
        ...
        bulletE() {
          ...
          var distance = math.Vec3.distance(this.node.position, (_crd && Plane === void 0 ? (_reportPossibleCrUseOfPlane({
            error: Error()
...
//# sourceMappingURL=cd4afd18c945c8e436398343bccaa0b1b1a916e2.js.map