    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_class3 = class JoyStick extends Component {
        ...
        onStickMove(event, dt) {
          ...
          this.direction = this.stickPos.clone().subtract(this.VecY).normalize();
          this.distance = math.Vec3.distance(this.VecY, this.stickPos); // let posX = this.plane.position.x + direction.x * distance * 0.05;
        ...
        movePlane() {
          var posX = this.plane.position.x + this.direction.x * this.distance * 0.05;
          var posY = this.plane.position.y + this.direction.y * this.distance * 0.05;
...
//# sourceMappingURL=79b70028e1bd33bdb45ec742b3e7f2799ebd38b6.js.map