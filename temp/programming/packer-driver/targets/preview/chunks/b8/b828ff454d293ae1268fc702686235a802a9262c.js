    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Animation), _dec(_class = (_class2 = (_class3 = class Boss extends Component {
        ...
        moveRandom() {
          ...
          console.log(this.listPos.length); // const distance = Vec3.distance(this.node.position, randomPosition);
...
//# sourceMappingURL=b828ff454d293ae1268fc702686235a802a9262c.js.map