      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Enemy extends Component {
        ...
        enemyMove() {
          if (this.node.name.endsWith('_0')) {
            ...
            var randomPosition = new Vec3((_crd && GameCtrl === void 0 ? (_reportPossibleCrUseOfGameCtrl({
              error: Error()
            }), GameCtrl) : GameCtrl).instance.node.parent.worldPosition);
...
//# sourceMappingURL=97aab77b248c15794e13f593e75ec8181883bc31.js.map